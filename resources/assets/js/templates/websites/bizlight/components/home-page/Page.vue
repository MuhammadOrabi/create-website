    ...
    <section>
        <b-field label="Home Page Should Contains?">
            <div class="block">
                ...
                <b-checkbox v-model="checkboxGroup" native-value="accordion">Accordion with image</b-checkbox>
                <b-checkbox v-model="checkboxGroup" native-value="horizontal-list">Horizontal List</b-checkbox>
                <b-checkbox v-model="checkboxGroup" native-value="paragraph-image">Paragraph with Image</b-checkbox>
            </div>
        </b-field>
        <b-tabs position="is-centered" class="block">
            ...
            <b-tab-item label="Accordion with an image" v-if="checkboxGroup.includes('accordion') && accordion">
            ...
            <b-tab-item label="Paragraph Image" v-if="checkboxGroup.includes('paragraph-image') && paragraphImage">
