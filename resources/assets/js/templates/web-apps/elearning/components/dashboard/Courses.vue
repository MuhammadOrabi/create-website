<template>
	<v-container>
		<create-update-course :token="token" :address="address" :id="id" operation="create" ></create-update-course>
			...
			<v-flex xs10 elevation-15>
    			<v-list avatar three-line>
		          	<template v-for="course in courses" >
			            <v-list-tile :key="course.id" :href="'/dashboard/sections/' + course.id">
							<v-list-tile-avatar>
