        ...
        <b-modal :active.sync="isFormModalActive" has-modal-card>
            <div class="modal-card has-text-left">
                <header class="modal-card-head">
                    <p class="modal-card-title">Add to list</p>
                </header>
                ...
                <section class="modal-card-body" v-else>
                    ...
                    <b-field horizontal label="Image">
                        <p class="control">
...
export default {
    ...
    name: 'HorizontalListForm',
    props: ['token', 'id', 'update', 'heading', 'paragraph', 'img', 'order', 'content', 'address'],
    data () {
        return {
            data: {
                heading: null,
