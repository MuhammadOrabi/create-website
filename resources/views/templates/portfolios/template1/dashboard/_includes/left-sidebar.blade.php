<div class="side-menu" id="left-side-menu">
    <aside class="menu m-t-30 m-l-10">
        ...
        <ul class="menu-list">
            <li>
                <a class="has-submenu {{ Nav::hasSegment('sections', 2) }}" href="#">
                    <span class="icon"><i class="fa fa-fw m-r-10 fa-list"></i></span> Sections
                </a>
                <ul class="submenu">
                    @foreach($page->sections as $section)
                        <li>
                            <a href="/dashboard/sections/update/{{ $section->id }}/{{ $site->address }}" class="{{ Nav::hasSegment($section->id,4) }}">
                                {{ $section->title }}
                            </a>
                        </li>
                    @endforeach
